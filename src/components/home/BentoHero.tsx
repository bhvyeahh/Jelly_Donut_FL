        ...
        <div className="col-span-1 md:col-span-2 md:row-span-2 rounded-[2rem] bg-background border border-border p-8 md:p-12 flex flex-col justify-center relative overflow-hidden group shadow-soft hover:shadow-xl transition-all duration-500">
          ...
          <div className="relative z-10 max-w-xl">
            ...
            <h1 className="text-5xl md:text-7xl font-serif font-bold leading-[1.1] mb-6 text-foreground">
              Donuts worth{" "}
              <span className="text-primary italic">obsessing</span> over.
            </h1>

            <p className="text-lg text-muted-foreground mb-8 max-w-md leading-relaxed">
              Handcrafted daily with premium ingredients and overflowing with
              our signature house-made jellies.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/menu">
                <Button
                  size="lg"
                  className="rounded-full text-lg px-8 h-12 shadow-lg shadow-primary/20 hover:shadow-primary/40 transition-all"
                >
                  View Menu
                </Button>
              </Link>
              ...
              <Link to="/about">
                <Button
                  variant="outline"
                  size="lg"
                  className="rounded-full text-lg px-8 h-12 border-2 hover:bg-secondary/20 transition-all"
                >
